<div class="w-full -mx-16" x-data="{
    ...
    <div class="fi-section-content-ctn py-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="fi-fo-field-wrp">
                    ...
                    <div
                        ...
                        <input type="date" wire:model.live="reconciliation_date"
            ...
            @if($current_reconciliation && $current_reconciliation->status->value === 'completed')
                <div
                    ...
                    <p class="text-yellow-600 dark:text-yellow-400">Ya existe un cuadre completado para este empleado en el
                        día de hoy.</p>
                    <p class="text-yellow-600 dark:text-yellow-400 text-sm mt-2">No se pueden realizar más modificaciones.
                    </p>
                </div>
            @else
                                            ...
                                            <div class="flex items-center gap-x-3 justify-between">
                                                ...
                                                <div>
                                                    <button type="button"
                                                        ...
                                                        <span
                                                            class="fi-btn-label">{{ $reconciliation_created ? 'Guardar Cuadre' : 'Iniciar Cuadre' }}</span>
                                                    </button>
                                                </div>
                                            </div>
                ...
                return ['id' => $emp->id, 'name' => $emp->first_name . ' ' . $emp->last_name, 'position' => $emp->position ?? 'Empleado']; })->toJson() }},
                                                        ...
                                                        <div class="fi-select-input-wrapper relative w-full">
                                                            ...
                                                            <div
                                                                class="absolute top-0 left-0 h-full flex items-center px-1 pointer-events-none">
                                                            ...
                                                            <input x-model="selectedEmployee ? selectedEmployee.name : search"
                                                            ...
                                                            <div class="absolute top-0 right-0 pt-2 px-2 flex items-center justify-end"
                                                                style="width: 100%;">
                                                        ...
                                                        <div x-show="open || showMinCharsMessage"
                                                            ...
                                                            <ul x-show="filteredEmployees.length > 0" x-ref="employeesList"
                                                                role="listbox"
                                                                class="fi-select-list max-h-64 overflow-y-auto overscroll-contain p-1">
                                                                <template x-for="(employee, index) in filteredEmployees"
                                                                    :key="employee.id">
                                                                    <li>
                                                                        <button @click="selectEmployee(employee)"
                                                                            ...
                                                                            role="option" :tabindex="index === 0 ? 0 : -1"
                                                            ...
                                                            <div x-show="noResults && search.length >= 4"
                                                                class="fi-select-empty-state px-3 py-2 text-sm text-gray-500 dark:text-gray-400">
                                                            ...
                                                            <div x-show="showMinCharsMessage"
                                                                class="fi-select-empty-state px-3 py-2 text-sm text-blue-600 dark:text-blue-400">
                                                                <div class="flex items-center justify-center gap-x-3 py-2">
                                                                    <svg class="h-5 w-5 text-blue-500 dark:text-blue-400"
                                                                        viewBox="0 0 20 20" fill="currentColor">
                                                                        <path fill-rule="evenodd"
                                                                            d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                                                                            clip-rule="evenodd" />
                                                                    </svg>
                                                                    <span>Escriba al menos 4 caracteres para ver
                                                                        resultados</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                @if($employee_id && count($sales) > 0)
                                    <div class="mb-3">
                                        <div
                                            ...
                                            <div
                                                class="fi-section-header-ctn flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
                                                <div>
                                                    <h4
                                                ...
                                                <div
                                                    ...
                                                    <span class="text-xs font-medium">{{ count($sales) }}
                                                        {{ count($sales) == 1 ? 'venta' : 'ventas' }}</span>
                                                </div>
                                            </div>
                                            <div class="fi-section-content">
                                                <div class="overflow-hidden">
                                                    <div class="overflow-x-auto" style="max-height: 290px;">
                                                        <div
                                                                    ...
                                                                    <tr class="bg-gray-50 dark:bg-white/5">
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Cliente</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Termino</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Tipo
                                                                                    Pago</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            ...
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Subtotal</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Total</span>
                                                                            </span>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody
                                                                    class="fi-ta-body divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5">
                                                                    @foreach($sales as $sale)
                                                                        <tr
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <div class="fi-ta-col-wrp px-3 py-4">
                                                                                    <div
                                                                                        class="fi-badge inline-flex items-center gap-x-1 rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset bg-gray-50 text-gray-700 ring-gray-600/10 dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/30">
                                                                                        {{ $sale['payment_method'] }}
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <div class="fi-ta-col-wrp px-3 py-4">
                                                                                    <div
                                                                                        class="fi-ta-text text-sm font-medium leading-6 text-gray-950 dark:text-white">
                                    ...
                                    <div class="mb-6 pt-3">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="inline-flex items-center justify-center rounded-full bg-primary-50 px-2.5 py-0.5 text-primary-700 dark:bg-primary-500/10 dark:text-primary-400">
                                                    <span class="text-xs font-medium">{{ count($payments) }}
                                                        {{ count($payments) == 1 ? 'cobro' : 'cobros' }}</span>
                                                </div>
                                            </div>
                                            <div class="fi-section-content">
                                                <div class="overflow-hidden">
                                                                    ...
                                                                    <tr class="bg-gray-50 dark:bg-white/5">
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Monto</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Método</span>
                                                                            </span>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                    ...
                                                                    @foreach($payments as $payment)
                                                                        <tr
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <div class="fi-ta-col-wrp px-3 py-4">
                                                                                    <div
                                                                                        class="fi-badge inline-flex items-center gap-x-1 rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset bg-primary-50 text-primary-700 ring-primary-600/10 dark:bg-primary-400/10 dark:text-primary-400 dark:ring-primary-400/30">
                                                                                        {{ $payment['method'] }}
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                ...
                                @if($employee_id && count($remaining_products) > 0)
                                    <div class="mb-6 mt-3">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-x-3">
                                                    <div class="flex items-center gap-x-2">
                                                        <label for="type-price-select"
                                                            class="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">Precios:</label>
                                                    ...
                                                    <button type="button" wire:click="returnAllRemainingProducts"
                                                        wire:loading.attr="disabled" wire:target="returnAllRemainingProducts"
                                            ...
                                            <div class="fi-section-content py-6 pt-0 px-0">
                                                <div class="overflow-y-auto" style="max-height: 290px;">
                                                    <div
                                                        class="fi-ta-ctn divide-y divide-gray-200 overflow-auto rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10">
                                                        <table
                                                            class="fi-ta-table w-full table-auto divide-y divide-gray-200 text-start dark:divide-white/5">
                                                            <thead
                                                                class="fi-ta-header divide-y divide-gray-200 dark:divide-white/5">
                                                                <tr class="bg-gray-50 dark:bg-white/5">
                                                                    <th
                                                                        class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                        <span
                                                                            class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Producto</span>
                                                                        </span>
                                                                    </th>
                                                                    <th
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Asignado</span>
                                                                        </span>
                                                                    </th>
                                                                    <th
                                                                        class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-center">
                                                                        <span
                                                                            class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-center">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Vendido</span>
                                                                        </span>
                                                                    </th>
                                                                    <th
                                                                        class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-center">
                                                                        <span
                                                                            class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-center">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Retornado</span>
                                                                        </span>
                                                                    </th>
                                                                    <th
                                                                        class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-center">
                                                                        <span
                                                                            class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-center">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Sobrante</span>
                                                                        </span>
                                                                    </th>
                                                                    <th
                                                                        class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-center">
                                                                        <span
                                                                            class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-center">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Efectivo
                                                                                Prod. Falt.</span>
                                                                        </span>
                                                                    </th>
                                                                </tr>
                                                                ...
                                                                @foreach($remaining_products as $product)
                                                                    <tr
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4">
                                                                                <div
                                                                                    class="fi-ta-text text-sm leading-6 text-gray-950 dark:text-white font-medium flex items-center gap-x-2">
                                                                                    {{ $product['product_name'] }}
                                                                                    <span
                                                                                        class="fi-badge inline-flex items-center rounded-md px-1.5 py-0.5 text-xs font-medium ring-1 ring-inset bg-gray-50 text-gray-600 ring-gray-500/10 dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/20">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4 text-center">
                                                                                <div
                                                                                    class="fi-ta-text text-sm leading-6 text-gray-950 dark:text-white font-semibold">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4 text-center">
                                                                                <div
                                                                                    class="fi-ta-text text-sm leading-6 text-blue-600 dark:text-blue-400 font-semibold">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4 text-center">
                                                                                @if($product['returned_quantity'] > 0)
                                                                                    ...
                                                                                    <div
                                                                                        class="fi-badge inline-flex items-center gap-x-1 rounded-md px-3 py-2 text-sm font-semibold ring-1 ring-inset bg-blue-50 text-blue-700 ring-blue-600/10 dark:bg-blue-400/10 dark:text-blue-400 dark:ring-blue-400/30">
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4 text-center">
                                                                                <div
                                                                                    class="fi-badge inline-flex items-center gap-x-1 rounded-md px-2 py-1 text-sm font-bold ring-1 ring-inset {{ $product['remaining'] > 0 ? 'bg-amber-50 text-amber-700 ring-amber-600/10 dark:bg-amber-400/10 dark:text-amber-400 dark:ring-amber-400/30' : 'bg-green-50 text-green-700 ring-green-600/10 dark:bg-green-400/10 dark:text-green-400 dark:ring-green-400/30' }}">
                                                                                    {{ $product['remaining'] }}
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td
                                                                            ...
                                                                            <div class="fi-ta-col-wrp px-3 py-4 text-center">
                                                                                <div
                                                                                    class="fi-ta-text text-sm font-semibold leading-6 {{ ($product['shortage_cash'] ?? 0) > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-gray-400 dark:text-gray-500' }}">
                                                                                    L
                                                                                    {{ number_format($product['shortage_cash'] ?? 0, 2) }}
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                ...
                                @if($employee_id)
                                    <div class="mb-6 mt-3">
                                        <div class="fi-section-content-ctn rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="inline-flex items-center justify-center rounded-full bg-orange-50 px-2.5 py-0.5 text-orange-700 dark:bg-orange-500/10 dark:text-orange-400">
                                                    <span class="text-xs font-medium">{{ count($returns) }}
                                                        {{ count($returns) == 1 ? 'devolución' : 'devoluciones' }}</span>
                                                </div>
                                            </div>
                                            <div class="fi-section-content p-6">
                                                <!-- Return Form (Collapsible) -->
                                                <div x-show="showReturnForm" x-transition:enter="transition ease-out duration-300"
                                                    ...
                                                    <h5 class="text-sm font-medium text-gray-950 dark:text-white mb-3">Registrar
                                                        Nueva Devolución</h5>
                                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                        <!-- Product Selection -->
                                                        <div class="relative">
                                                            <label
                                                                class="fi-fo-field-wrp-label inline-flex items-center gap-x-1 text-sm font-medium leading-5 text-gray-950 dark:text-white mb-1">
                                                                Producto
                                                            </label>
                                                            <div class="relative">
                                                                <input wire:model.live="product_search" type="text"
                                                                ...
                                                                @if($selected_product)
                                                                    ...
                                                                    <div class="absolute top-0 right-0 pt-2 px-2 flex items-center justify-end"
                                                                        style="width: 100%;">
                                                                        <button wire:click="clearProductSelection" type="button"
                                                                        ...
                                                                        <button wire:click="selectProduct({{ $product['id'] }})"
                                                                            ...
                                                                            <div class="flex items-start justify-between">
                                                                                <div class="flex-1 min-w-0">
                                                                                    <div class="font-medium truncate">{{ $product['name'] }}
                                                                                    </div>
                                                                                    <div
                                                            ...
                                                            @if($show_product_dropdown && count($filtered_products) === 0 && strlen($product_search) >= 3)
                                                                <div
                                                                    class="absolute z-50 mt-1 w-full bg-white dark:bg-gray-800 shadow-lg rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select wire:model="return_type"
                                                                class="fi-select-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm">
                                                                <option value="">Seleccione el tipo</option>
                                                                @foreach($return_types as $key => $label)
                                                                    <option value="{{ $key }}">{{ $label }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('return_type') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number" min="1" wire:model="return_quantity"
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <textarea wire:model="return_reason" rows="2"
                                                                placeholder="Describa el motivo de la devolución"
                                                                class="fi-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm"></textarea>
                                                            @error('return_reason') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="flex items-center h-5">
                                                                <input type="checkbox" wire:model="return_affects_inventory"
                                                                    class="fi-checkbox-input rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:focus:border-primary-600 dark:focus:ring-primary-600" />
                                                            </div>
                                                            <div class="px-2 text-sm">
                                                                <label class="font-medium text-gray-700 dark:text-gray-300">Afecta
                                                                    Inventario</label>
                                                                <p class="text-gray-500 dark:text-gray-400 text-xs">Marque si esta
                                                                    devolución debe registrar movimiento de inventario</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <tr class="bg-gray-50 dark:bg-white/5">
                                                                            ...
                                                                            <th
                                                                                ...
                                                                                <span
                                                                                    class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                    <span
                                                                                        class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Cantidad</span>
                                                                                </span>
                                                                            </th>
                                                                            <th
                                                                                class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                                <span
                                                                                    class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                    <span
                                                                                        class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Tipo</span>
                                                                                </span>
                                                                            </th>
                                                                            <th
                                                                                class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                                <span
                                                                                    class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                    <span
                                                                                        class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Motivo</span>
                                                                                </span>
                                                                            </th>
                                                                            <th
                                                                                class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                                <span
                                                                                    class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                    <span
                                                                                        class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Inventario</span>
                                                                                </span>
                                                                            </th>
                                                                            <th
                                                                                class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                        ...
                                                                        @foreach($returns as $return)
                                                                            <tr
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    <div class="fi-ta-col-wrp px-3 py-4">
                                                                                        <span
                                                                                            class="fi-badge flex items-center justify-center gap-x-1 rounded-md text-xs font-medium ring-1 ring-inset px-2 py-1 fi-color-custom bg-orange-50 text-orange-600 ring-orange-600/10 dark:bg-orange-400/10 dark:text-orange-400 dark:ring-orange-400/30">
                                                                                            {{ $return['type'] }}
                                                                                        </span>
                                                                                    </div>
                                                                                </td>
                                                                                <td
                                                                                    class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3">
                                                                                    <div class="fi-ta-col-wrp px-3 py-4">
                                                                                        <div class="fi-ta-text text-sm leading-6 text-gray-950 dark:text-white truncate max-w-32"
                                                                                            title="{{ $return['reason'] }}">
                                                                                            {{ $return['reason'] }}
                                                                                        </div>
                                                                                    </div>
                                    ...
                                    <div
                                        class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 mb-6 mt-3">
                                        <div class="fi-section-header flex flex-col gap-3 p-6 pb-0 px-0">
                                            <div class="flex items-center justify-between gap-x-3">
                                                ...
                                                <div
                                                    ...
                                                    <span class="text-xs font-medium">{{ count($movements) }}
                                                        {{ count($movements) == 1 ? 'movimiento' : 'movimientos' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="fi-section-content py-6 pt-0 px-0">
                                                                    ...
                                                                    <tr class="bg-gray-50 dark:bg-white/5">
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Nota</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-start">
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <span
                                                                                class="group flex w-full items-center gap-x-1 whitespace-nowrap justify-start">
                                                                                <span
                                                                                    class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white">Venta</span>
                                                                            </span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 text-center">
                                                                    ...
                                                                    @foreach($movements as $movement)
                                                                        <tr
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <div class="fi-ta-col-wrp px-3 py-4">
                                                                                    <span
                                                                                        class="fi-badge flex items-center justify-center gap-x-1 rounded-md text-xs font-medium ring-1 ring-inset px-2 py-1 {{ $movement['type_raw'] === 'change' ? 'fi-color-info bg-blue-50 text-blue-600 ring-blue-600/10 dark:bg-blue-400/10 dark:text-blue-400 dark:ring-blue-400/30' : 'fi-color-success bg-green-50 text-green-600 ring-green-600/10 dark:bg-green-400/10 dark:text-green-400 dark:ring-green-400/30' }}">
                                                                                        {{ $movement['type'] }}
                                                                                    </span>
                                                                                </div>
                                                                            </td>
                        ...
                        <div class="custom-col-35 -ml-2 sticky-slidebar">
                            <div class="custom-bg-light p-2 rounded-lg border border-gray-200">
                                @if($employee_id)
                                    <!-- Financial Summary -->
                                    <div
                                        class="fi-section rounded-lg bg-white p-2 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 mb-6">
                                            ...
                                            <ul class="fi-ta-list divide-y divide-gray-200 dark:divide-gray-700">
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_cash_sales, 2) }}</span>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between items-center mt-1 pl-8">
                                                        ...
                                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-400">L
                                                            {{ number_format($total_cash_sales - $total_deposit_sales, 2) }}</span>
                                                    </div>
                                                    <div class="flex justify-between items-center mt-1 pl-8">
                                                        <span class="text-xs text-gray-600 dark:text-gray-400">Depósitos</span>
                                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-400">L
                                                            {{ number_format($total_deposit_sales, 2) }}</span>
                                                    </div>
                                                </li>
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_credit_sales, 2) }}</span>
                                                    </div>
                                                </li>
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_collections, 2) }}</span>
                                                    </div>
                                                    <!-- Desglose de Cobros Realizados -->
                                                    <div class="flex justify-between items-center mt-1 pl-8">
                                                        <span class="text-xs text-gray-600 dark:text-gray-400">Efectivo</span>
                                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-400">L
                                                            {{ number_format($total_cash_collections, 2) }}</span>
                                                    </div>
                                                    <div class="flex justify-between items-center mt-1 pl-8">
                                                        <span class="text-xs text-gray-600 dark:text-gray-400">Depósitos</span>
                                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-400">L
                                                            {{ number_format($total_deposit_collections, 2) }}</span>
                                                    </div>
                                                </li>
                                                <li class="fi-ta-item p-2 bg-gray-50 dark:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-bold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_sales, 2) }}</span>
                                                    </div>
                                                </li>
                                                <!-- Separator -->
                                                ...
                                                <li
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-amber-600 dark:text-amber-400">L
                                                            {{ number_format($product_shortage_total, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_cash_expected, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-red-600 dark:text-red-400">L
                                                            {{ number_format($total_bills, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span
                                                            class="font-semibold {{ $cash_difference < 0 ? 'text-red-600' : 'text-green-600' }} dark:{{ $cash_difference < 0 ? 'text-red-400' : 'text-green-400' }}">L
                                                            {{ number_format($cash_difference, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($deposits_made, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span class="font-semibold text-gray-950 dark:text-white">L
                                                            {{ number_format($total_deposit_expected, 2) }}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fi-ta-item p-2 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span
                                                            class="font-semibold {{ $deposit_difference < 0 ? 'text-red-600' : 'text-green-600' }} dark:{{ $deposit_difference < 0 ? 'text-red-400' : 'text-green-400' }}">L
                                                            {{ number_format($deposit_difference, 2) }}</span>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="fi-section rounded-lg bg-white p-2 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 mt-2"
                                        x-data="{ showDepositForm: false }">
                                        <div class="fi-section-header mb-1">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-x-1">
                                                    <span
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div x-show="showDepositForm" x-transition:enter="transition ease-out duration-300"
                                                    ...
                                                    <div class="space-y-2">
                                                        ...
                                                        <div class="mb-1">
                                                            <label
                                                                class="fi-fo-field-wrp-label inline-flex items-center gap-x-1 text-sm font-medium leading-5 text-gray-950 dark:text-white">
                                                                Monto
                                                            </label>
                                                            <input type="number" step="0.01" placeholder="0.00"
                                                                wire:model="deposit_amount"
                                                                class="fi-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm" />
                                                            @error('deposit_amount') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <select wire:model="deposit_bank"
                                                                class="fi-select-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm">
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" placeholder="Número de referencia"
                                                                wire:model="deposit_reference"
                                                                class="fi-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm" />
                                                            @error('deposit_reference') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="mt-2">
                                                    <h4
                                                        class="fi-section-header-heading text-xs font-medium text-gray-950 dark:text-white mb-1">
                                                        Depósitos Registrados</h4>
                                                    <div
                                                        class="fi-ta rounded-lg bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                                                        <div class="fi-ta-content relative overflow-x-auto">
                                                            <table
                                                                class="fi-ta-table w-full divide-y divide-gray-200 text-start dark:divide-white/5">
                                                                <thead>
                                                                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                                                                        <th
                                                                            class="fi-ta-header-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Banco</span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Referencia</span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2">
                                                                            <span
                                                                ...
                                                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                                    @forelse($deposits as $deposit)
                                                                        <tr
                                                                            class="fi-ta-row hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                                                            <td
                                                                                class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2 py-1.5 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300">
                                                                                {{ $deposit['bank'] }}
                                                                            </td>
                                                                            <td
                                                                                class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2 py-1.5 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300">
                                                                            ...
                                                                            <td
                                                                                class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2 py-1.5 whitespace-nowrap text-xs font-medium text-gray-900 dark:text-white">
                                                            ...
                                                            <div class="mt-2 p-2 bg-gray-50 dark:bg-gray-700 rounded-md">
                                                                <div class="flex justify-between items-center">
                                                                    <span
                                                                        class="text-xs font-medium text-gray-700 dark:text-gray-300">Total
                                                                        Depósitos Realizados:</span>
                                                                    <span
                                                                        class="text-sm font-semibold text-gray-900 dark:text-white">L
                                                                        {{ number_format(collect($deposits)->sum('amount'), 2) }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="space-y-2">
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" placeholder="Descripción del gasto"
                                                                wire:model="bill_description"
                                                                class="fi-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm" />
                                                            @error('bill_description') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" placeholder="Número de referencia o factura"
                                                                wire:model="bill_reference"
                                                                class="fi-input block w-full border-gray-300 rounded-lg shadow-sm outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500 text-sm" />
                                                            @error('bill_reference') <span
                                                            class="text-xs text-red-500">{{ $message }}</span> @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="fi-ta-content relative overflow-x-auto">
                                                                ...
                                                                <thead>
                                                                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                                                                        <th
                                                                            class="fi-ta-header-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2">
                                                                            <span
                                                                                class="fi-ta-header-cell-label text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Descripción</span>
                                                                        </th>
                                                                        <th
                                                                            class="fi-ta-header-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-2 sm:last-of-type:pe-2">
                                                                            <span
                                                            ...
                                                            <div class="mt-2 p-2 bg-red-50 dark:bg-red-700 rounded-md">
                                                                <div class="flex justify-between items-center">
                                                                    <span
                                                                        class="text-xs font-medium text-red-700 dark:text-red-300">Total
                                                                        Gastos Realizados:</span>
                                                                    <span
                                                                        class="text-sm font-semibold text-red-900 dark:text-white">L
                                                                        {{ number_format(collect($bills)->sum('amount'), 2) }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="mt-2 text-sm text-gray-700">
                                                        ...
                                                        <p class="mt-1">ID del Cuadre:
                                                            <strong>#{{ $current_reconciliation->id }}</strong>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
